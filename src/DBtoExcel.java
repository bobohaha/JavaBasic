...
public class DBtoExcel {  
     ...
     */  
    public void WriteExcel(ResultSet rs, WritableWorkbook workbook,String sheetName,int numb, Vector<String> columnName) {  
//        WritableWorkbook workbook = null;  
        WritableSheet sheet = null;  
        int rowNum = 1; // 从第一行开始写入  
        try {  
            sheet = workbook.createSheet(sheetName, numb); // 创建名为 sheetName 的工作簿    
